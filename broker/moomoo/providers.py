...
from broker.moomoo.config import FutuBrokersInstrumentProviderConfig


# fmt: on


class FutuBrokersInstrumentProvider(InstrumentProvider):
    """
    ...
    def __init__(
            self,
            config: FutuBrokersInstrumentProviderConfig,
    ) -> None:
        """
