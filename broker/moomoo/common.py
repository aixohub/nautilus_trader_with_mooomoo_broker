...
from futu import PositionSide, Currency, TrdSide, TimeInForce, OrderType, OrderStatus
...
FUTU: Final[str] = "FUTUBROKERS"
FUTU_VENUE: Final[Venue] = Venue(FUTU)
NASDAQ_VENUE: Final[Venue] = Venue("NASDAQ")
FUTU_CLIENT_ID: Final[ClientId] = ClientId(FUTU)


class FutuPosition(NamedTuple):
    account_id: str
